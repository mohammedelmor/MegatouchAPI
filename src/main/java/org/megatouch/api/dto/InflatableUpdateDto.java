 ...
 */
public record InflatableUpdateDto(
        @NotNull(message = "Inflatable must have an id") @Positive Long id,
        @NotEmpty(message = "English name can't be empty") String enName,
